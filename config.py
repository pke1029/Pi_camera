rotation = 270              # camera orientation
...
threshold = 20              # difference in each pixel [0, 256]
sensitivity = 400           # difference in each frame [0, lo_res width * lo_res height] 
log_day = 7                 # number of days to keep the log of
